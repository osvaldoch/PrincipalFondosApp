...
static NSString * const KDASExtensionFaceLivenessContinuityStrict           = @"liveness.continuity.strict";
static NSString * const KDASExtensionFaceLivenessServerResolution           = @"liveness.server.resolution";
